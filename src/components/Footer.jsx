...
const Footer = () => {
    return (
        <div className='w-full mt-24 bg-[#873e23] text-white py-y px-2'>
            <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-white py-8'>
                ...
                <div className='col-span-2 pt-8 md:pt-2'>
                    ...
                    <form className='flex flex-col sm:flex-row'>
                        ...
                        <button className='p-2 mb-4 bg-slate-200 text-[#873e23] rounded-3xl'>Subscribe</button>
                    </form>
                </div>
            </div>

            <div className='flex flex-col max-w-[1240px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-white'>
                <p className='py-4'>© Tasbiha 2023</p>
